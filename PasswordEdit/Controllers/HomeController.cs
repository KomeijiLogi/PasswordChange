...
namespace PasswordEdit.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index(FormCollection f)
        {
            ...
            String msg= ResetPw(userName, oldPassword, newPassword, newPassword_twice);
           return Content(msg);
            //return View("Index");

        }
      
        public String ResetPw(string userName, String oldPassword, String newPassword, String newPassword_twice)
        {
            String msg = "";
